...
namespace FinalProjectAl1.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,LeaveTypeName,LeaveTypeNumberOfDays")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,LeaveTypeName,LeaveTypeNumberOfDays")] LeaveType leaveType)
        {
